    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/overcastan/Desktop/Testing/TechProgTemplates/task5/build/googletest_repo-prefix/src/googletest_repo'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/overcastan/Desktop/Testing/TechProgTemplates/task5/build/googletest_repo-prefix/src/googletest_repo'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
